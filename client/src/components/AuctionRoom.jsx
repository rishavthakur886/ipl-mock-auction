  ...
  if (!currentPlayer) {
    return (
      <div style={{ height: "100vh", background: "radial-gradient(circle at center, #1e293b 0%, #0f172a 100%)", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", color: "white", fontFamily: "'Segoe UI', sans-serif" }}>
         ...
         <p style={{marginTop: "20px", fontSize: "0.8rem", color: "#64748b"}}>Status: Localhost Connected</p>
      </div>
    );
  }
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "15px" }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: "15px", alignItems: "center" }}>
              ...
              <span style={{ fontSize: "14px", color: canAffordStandard ? "#4ade80" : "#ef4444", fontWeight: "bold", textShadow: "0 0 10px rgba(74, 222, 128, 0.3)" }}>Purse: ₹{myPurse.toFixed(2)} Cr</span>
            </div>
          </div>
        </div>
        <div style={{ display: "flex", gap: "10px" }}>
          <button onClick={handleDownloadSquad} style={{ padding: "8px 16px", background: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.2)", borderRadius: "6px", color: "white", fontWeight: "bold", cursor: "pointer", fontSize: "13px" }}>📥 SAVE</button>
          <button onClick={() => setShowSquads(!showSquads)} style={{ padding: "8px 16px", background: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.2)", borderRadius: "6px", color: "white", fontWeight: "bold", cursor: "pointer", fontSize: "13px" }}>VIEW ALL</button>
          <button onClick={onLogout} style={{ padding: "8px 16px", background: "#ef4444", border: "none", borderRadius: "6px", color: "white", fontWeight: "bold", cursor: "pointer", fontSize: "13px" }}>EXIT</button>
        </div>
      </div>
        ...
        <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "20px", position: "relative" }}>
          ...
          {currentPlayer ? (
            <div style={{ width: "100%", maxWidth: "750px", textAlign: "center", position: "relative" }}>
              <div style={{ background: "linear-gradient(180deg, rgba(30, 41, 59, 0.9) 0%, rgba(15, 23, 42, 0.95) 100%)", borderRadius: "24px", border: "1px solid rgba(255,255,255,0.1)", padding: "40px", boxShadow: "0 25px 60px -12px rgba(0, 0, 0, 0.6)" }}>
                  ...
                  {isOpening ? (
                    <button 
                      ...
                      style={{ 
                        ...
                        boxShadow: canAffordStandard ? "0 10px 25px -5px rgba(124, 58, 237, 0.5)" : "none",
